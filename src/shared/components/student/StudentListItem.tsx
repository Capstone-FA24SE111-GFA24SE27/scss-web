	...
	return (
		<>
			<ListItemButton
				...
				className="flex items-center gap-24 p-8 px-24 py-16"
				...
				<Box className='flex flex-col justify-between gap-8'>
					...
					<div className="flex items-center gap-16">
						<div className="flex items-center w-120">
							...
							<div className="ml-8 leading-6 text-text-secondary">{student.profile.phoneNumber}</div>
						</div>
						<div className="flex items-center">
							<EmailOutlined fontSize='small' />
							<div className="ml-8 leading-6 text-text-secondary">{student.email}</div>
						</div>
					</div>
