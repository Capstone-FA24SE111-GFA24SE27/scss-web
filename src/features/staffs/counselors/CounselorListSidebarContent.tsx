...
import { selectCounselorType, selectFilter, setAvailableFrom, setAvailableTo } from './counselor-list-slice'
...
const CounselorListSidebarContent = () => {
  ...
  return (
    <div className='flex flex-col gap-16 p-24 min-h-ful bg-background-paper'>
      ...
      <div>
        <Typography className='mb-8 text-lg font-semibold'>Select available date range</Typography>
        <DateRangePicker
          className='mt-8'
      ...
      {/* <div>
        <Typography className='mb-8 text-lg font-semibold'>Select {counselingType === 'ACADEMIC' ? 'specialization' : 'expertise'}</Typography>
        {
      ...
      <div className='mt-8'>
        <Typography className="mb-8 text-lg font-semibold">Select by gender</Typography>
