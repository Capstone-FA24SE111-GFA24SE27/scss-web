...
const CounselorListSidebarContent = () => {
	...
	const handleGenderChange = (value: 'MALE' | 'FEMALE' | null) => {
	...
	return (
		<div className='flex flex-col gap-16 px-16 pt-24 rounded-lg'>
			...
			<div>
				...
				{counselingType === 'ACADEMIC' ? (
					<AcademicFilter
						className='mt-8'
						initialDeparment={filter.departmentId?.toString()}
						initialMajor={filter.majorId?.toString()}
						initialSpecialization={filter.specializationId?.toString()}
