 ...
 * Lazy loading
 */
rootReducer.inject(adminStudentListSlice);
const injectedSlice = adminStudentListSlice.injectInto(rootReducer);
...
export default adminStudentListSlice.reducer;

declare module '@shared/store' {
  export interface LazyLoadedSlices extends WithSlice<typeof adminStudentListSlice> { }
}
