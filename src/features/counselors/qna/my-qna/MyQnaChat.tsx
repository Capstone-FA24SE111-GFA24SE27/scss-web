...
const ConversationDetail = () => {
  ...
  return (
    <div className="flex flex-col w-full relative">
      <div className='bg-background-paper p-20 space-y-8'>
      ...
      <div className='bg-background-paper p-8'>

        <Scrollbar className="p-16 space-y-8 overflow-y-auto !h-[calc(100vh-265px)] bg-background">
