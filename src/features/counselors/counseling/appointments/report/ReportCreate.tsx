                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <ReactQuill
                      ...
                      value={watch('consultationGoal.specificGoal')} // Use watch here
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <ReactQuill
                      {...field}
                      className="mb-4 h-full"
                      value={watch('consultationGoal.reason')} // Use watch here
                      onChange={field.onChange}
                    />
                  )}
                />
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <ReactQuill
                      {...field}
                      className="mb-4 h-full"
                      value={watch('consultationContent.summaryOfDiscussion')} // Use watch here
                      onChange={field.onChange}
                    />
                  )}
                />
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <ReactQuill
                      {...field}
                      className="mb-4 h-full"
                      value={watch('consultationContent.mainIssues')} // Use watch here
                      onChange={field.onChange}
                    />
                  )}
                />
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <ReactQuill
                      {...field}
                      className="mb-4 h-full"
                      value={watch('consultationContent.studentEmotions')} // Use watch here
                      onChange={field.onChange}
                    />
                  )}
                />
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <ReactQuill
                      {...field}
                      className="mb-4 h-full"
                      value={watch('consultationContent.studentReactions')} // Use watch here
                      onChange={field.onChange}
                    />
                  )}
                />
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <ReactQuill
                      {...field}
                      className="mb-4 h-full"
                      value={watch('consultationConclusion.counselorConclusion')} // Use watch here
                      onChange={field.onChange}
                    />
                  )}
                />
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <ReactQuill
                      {...field}
                      className="mb-4 h-full"
                      value={watch('consultationConclusion.followUpNotes')} // Use watch here
                      onChange={field.onChange}
                    />
                  )}
                />
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <ReactQuill
                      {...field}
                      className="mb-4 h-full"
                      value={watch('intervention.type')} // Use watch here
                      onChange={field.onChange}
                    />
                  )}
                />
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <ReactQuill
                      {...field}
                      className="mb-4 h-full"
                      value={watch('intervention.description')} // Use watch here
                      onChange={field.onChange}
                    />
                  )}
                />
