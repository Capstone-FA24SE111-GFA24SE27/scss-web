...
const DemandsOverview = () => {
  ...
  const groupedByWeek = groupAppointmentsByWeek(demands);
  const groupedByDay = groupAppointmentsByDay(demands)
  ...
  return (
    <Paper className="p-16 space-y-8">
      <div className="flex justify-between gap-16">
        <Typography className="font-semibold text-2xl">Counseling Demands Overview</Typography>
