...
const QnaList = () => {
	...
	const countUnreadMessages = (qnaItem: Question) => {
		const readMessages = qnaItem?.chatSession?.messages.filter(
											...
											<div className='flex flex-col gap-8'>
												<div className='flex gap-8'>
													...
													<Chip
														...
														color={
															statusColor[
																qna.status as string
															]
														}
														size='small'
													/>
													<Chip
														label={qna.topic.name}
														size='small'
													/>
													{qna.taken && (
														<Chip
															label={`Taken by ${qna?.counselor.profile.fullName}`}
															variant='outlined'
															color={'success'}
															size='small'
														/>
