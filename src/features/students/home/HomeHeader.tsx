...
import { useGetCounselingAppointmentQuery } from '../services/activity/activity-api';
...
function HomeHeader() {
  ...
  const { data: upcomingAppointmentsData, isLoading, refetch } = useGetCounselingAppointmentQuery({
    fromDate: today,
    status: `WAITING`,
  });
        ...
        <div className="flex flex-auto items-center min-w-0">
          ...
          <div className="flex flex-col min-w-0 mx-16">
            ...
            <Typography className='text-lg'>
              {`You have ${upcomingAppointmentsData?.content.totalElements} upcoming appointemtns`}
            </Typography>
          </div>
        </div>
      </div>
